...
import { StyleSheet, Text,   Button, TouchableOpacity, Alert, View, Image, SafeAreaView, Animated, PanResponder} from 'react-native';
 ...
 <Text style = {styles.schedule1text}> GDYO </Text>  
      ...
      <View style={styles.pc} >
        ...
        <View style={styles.cc}>
          ...
          <Text style = {styles.schedule3textEvent}> Philharmonic and Wind</Text>
